...
from xtuner.v1.data_proto.messages import ChatMessages, Glm47ChatMessages, Glm52ChatMessages, Qwen35ChatMessages
...
class OpenaiTokenizeFunction(CachableTokenizeFunction[DataItem]):
    ...
    def __call__(self, item: dict | list, **kwargs) -> DataItem | CacheItem:
        ...
        elif self.chat_template_name == "glm4.7":
            messages = Glm47ChatMessages(messages=item, tools=tools)
